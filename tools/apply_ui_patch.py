...
replacement = '''    private fun applyTurquoiseButtonStyle() {
        ...
        listOf(playButton, previousButton, nextButton, randomButton).forEach { button ->
        ...
        listOf(downloadButton, cancelDownloadButton, pauseDownloadButton,
            saveButton, libraryButton, historyButton).forEach { button ->
    ...
    private fun setupCategoriesDrawer() {
        ...
        wrapper.addView(original, android.widget.FrameLayout.LayoutParams(
        ...
        wrapper.addView(scrim, android.widget.FrameLayout.LayoutParams(
            android.widget.FrameLayout.LayoutParams.MATCH_PARENT,
            android.widget.FrameLayout.LayoutParams.MATCH_PARENT))
        wrapper.addView(drawer, android.widget.FrameLayout.LayoutParams(
            dp(300), android.widget.FrameLayout.LayoutParams.MATCH_PARENT, Gravity.END))
        ...
        wrapper.addView(categoryButton, android.widget.FrameLayout.LayoutParams(
            dp(52), dp(52), Gravity.END or Gravity.TOP).apply {
                topMargin = dp(18)
                rightMargin = dp(12)
            })
    }
