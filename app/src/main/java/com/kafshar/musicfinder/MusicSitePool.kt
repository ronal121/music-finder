...
/**
 * Full music-source bank used by the direct site-search architecture.
 *
 * Google is not required for this path. The provider searches these sources
 * directly and then inspects returned pages for playable audio.
 */
