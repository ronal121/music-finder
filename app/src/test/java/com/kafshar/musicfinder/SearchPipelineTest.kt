...
class SearchPipelineTest {
    ...
    @Test fun googleRedirectWithEmptyQUsesUrlParameter() {
        val googleRedirect = "https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&url=https%3A%2F%2Frozmusic.com%2Fsong.html"
        assertEquals("https://rozmusic.com/song.html", GoogleResultParser.normalizeUrl(googleRedirect))
    }
